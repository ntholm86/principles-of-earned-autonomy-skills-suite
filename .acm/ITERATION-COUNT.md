...
| v3 (audit-trail) | 2026-04-23 — present | 279 | Committed Trail entries; some commits contain multiple iterations |
| **Total** | | **368** | |
...
The claim of 368 self-targeted iterations is conservative. It counts only iterations that produced a GENBA entry or audit-trail entry. Many commits represent significant work (design discussions, infrastructure changes, documentation passes) that did not receive a run number. Before this iteration is committed, the git log contains 473 total commits; the iteration count is 368. Commit count and iteration count measure different things because some commits preserve multiple iterations.
